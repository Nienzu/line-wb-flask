...
assert channel_secret is not None,'Specify LINE_CHANNEL_SECRET as environment variable.'
assert channel_access_token is not None,'Specify LINE_CHANNEL_ACCESS_TOKEN as environment variable.'
